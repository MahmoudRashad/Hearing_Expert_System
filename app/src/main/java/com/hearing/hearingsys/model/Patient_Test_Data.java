...
public class Patient_Test_Data {
    ...
    public Patient_Test_Data(int p_id, String p_name, String p_age, String noise_type, String test_Degree, String dr_name) {
        P_ID=p_id;
        P_name = p_name;
        P_age = p_age;
    ...
    public Patient_Test_Data() {

    }

//    public Patient_Test_Data(Object o) {
//        P_ID=o.;
//        P_name = p_name;
//        P_age = p_age;
//        Noise_type = noise_type;
